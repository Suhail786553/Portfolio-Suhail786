...
function ContactMe() {
  return (
    <div className="text-black py-12 px-6" id='contact'>
      ...
      <a  href="mailto:mauryaashvini99@gmail.com" target="_blank" className="flex items-center justify-center space-x-2 text-xl font-semibold">
        <img 
