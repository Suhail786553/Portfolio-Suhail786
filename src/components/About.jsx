...
function About() {
  ...
  return (
    <div className="flex flex-col items-start text-3xl font-mono font-bold text-start p-8 rounded-lg border border-cyan-400 shadow-lg max-w-3xl mx-auto mt-10 transition-transform transform hover:scale-105 animate-fadeIn" id='about'>
      <h2 className="text-4xl mb-4 text-black" data-aos="fade-up">About Me 👋</h2>
      <div className="text-black-300" data-aos="fade-up">
        <p className="font-semibold text-base py-2">
          <span className="text-rose-950">Hi, I’m Ashwini Maurya—</span> a frontend developer with a passion for transforming bold ideas into sleek, high-performance web applications. Whether it’s creating seamless user experiences or crafting clean, efficient code, I bring creativity and precision to every project I tackle. 🚀
        </p>
        <p className="font-semibold text-base py-2" data-aos="fade-up" data-aos-delay="100">
          Armed with skills in <span className="text-rose-950">HTML, CSS, JavaScript, React, and TypeScript</span>, I create responsive user experiences that don’t just look good—they feel good. ✨
        </p>
        <p className="font-semibold text-base py-2" data-aos="fade-up" data-aos-delay="200">
          Before diving into the world of web development, I honed my analytical skills at <span className="text-rose-950">Accenture</span>, where I developed a keen focus on quality and efficiency. Now, I blend that precision with a passion for clean code and creative design, bringing every project to life with a balance of logic and artistry. 🎨
        </p>
